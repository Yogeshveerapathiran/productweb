    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                Copyright &copy;2023 Developed by dubai</footer></div>
            </div>
        </div>
    </body>
</html>
    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright &copy;2023 Developed by dubaithatha</footer></div>
            </div>
        </div>
    </body>
</html>
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Tharun kumar</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Kamalesh</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Shakthi</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Dhansu</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>Dhansu</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>Vasanth</h2></b></p></div><br>
    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright &copy;2023 Developed by dubai camel</footer></div>
            </div>
        </div>
    </body>
</html>
